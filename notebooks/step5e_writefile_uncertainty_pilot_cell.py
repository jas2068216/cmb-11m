# Paste this into a NEW Colab cell. Materializes harness/uncertainty_pilot.py.
# Run AFTER pipeline_bootstrap_cell.py and BEFORE step6_uncertainty_probe_pilot_cell.py.

%%writefile /content/cmb_llm/harness/uncertainty_pilot.py
...
20 cases = 10 KNOWN + 10 UNCERTAIN (labeled by pair_id x condition).
"""
