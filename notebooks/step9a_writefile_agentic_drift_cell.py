# Paste into a NEW Colab cell. Materializes harness/agentic_drift_pilot.py.
# Run AFTER pipeline_bootstrap_cell.py and BEFORE step9b_agentic_drift_pilot_cell.py.

%%writefile /content/cmb_llm/harness/agentic_drift_pilot.py
