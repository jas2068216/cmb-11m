# Paste this into a NEW Colab cell. Materializes harness/r_restoration.py.
# Run BEFORE the step5_r_restoration_v2_cell.py cell.

%%writefile /content/cmb_llm/harness/r_restoration.py
