# Paste into a NEW Colab cell. Materializes harness/rag_faithfulness.py (40 pairs).
# Run AFTER pipeline_bootstrap_cell.py and BEFORE step8b_rag_full_probe_control_cell.py.

%%writefile /content/cmb_llm/harness/rag_faithfulness.py
