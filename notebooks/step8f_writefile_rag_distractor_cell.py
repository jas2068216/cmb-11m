# Paste into a NEW Colab cell. Materializes harness/rag_distractor_control.py.
# Run AFTER pipeline_bootstrap_cell.py and BEFORE step8g_rag_distractor_test_cell.py.

%%writefile /content/cmb_llm/harness/rag_distractor_control.py
