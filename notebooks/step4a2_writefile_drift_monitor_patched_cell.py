# Paste into a NEW Colab cell. %%writefile must be the first line.
# Overwrites the previous drift_monitor.py with the patched version:
#   - default Wasserstein threshold raised 0.5 -> 1.0
#   - new ks_pvalue_threshold parameter (default 0.01)
#   - new alert_mode parameter (default 'ks')
#   - new tune_thresholds_from_baseline() method
#   - save/load round-trips the calibrated thresholds
